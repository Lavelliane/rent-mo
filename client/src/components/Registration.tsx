...
const Registration = () => {
  ...
  return (
    <>
    <div
        className="h-screen w-full bg-cover bg-center flex flex-col font-Messina-Sans justify-center"
        style={{ backgroundImage: `url(${BgHomepage})` }}
      >
        <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
            <div className="bg-white shadow-searchbox rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                ...
                <div className="flex flex-row gap-5">
                    <div className="flex flex-col w-full">
                        ...
                        <input onChange={handleChange} value={user.firstName} name="firstName" id="firstName" aria-labelledby="text"  type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="e.g: Juan " />
                    </div>
                    <div className="flex flex-col w-full">
                        ...
                        <input onChange={handleChange} value={user.lastName} name="lastName" aria-labelledby="text" type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="e.g: Cruz " />
                    </div>
                </div>
                <div className="mt-4 w-full">
                    ...
                    <input onChange={handleChange} value={user.email} name="email" aria-labelledby="email" type="email" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="e.g: john@gmail.com " />
                </div>
                <div className="mt-4 w-full">
                    ...
                    <div className="relative flex items-center justify-center">
                        <input onChange={handleChange} value={user.password} name="password" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                ...
                <div className="mt-8">
                    ...
                    <button onSubmit={() => handleSubmit} role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-yellow text-sm font-semibold leading-none text-black focus:outline-none bg-yellow rounded hover:opacity-70 py-4 w-full">
                        Create my account
                    </button>
                </div>
                <div className="mt-8">
                    <button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-yellow text-sm font-semibold leading-none text-white focus:outline-none bg-dark600 rounded hover:opacity-70 py-4 w-full transition">
                        Return
                    </button>
                </div>
            </div>
