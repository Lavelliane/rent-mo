...
const Footer = () => {
	return (
		<div className='flex flex-col mx-auto h-fit w-full text-white bg-dark800 shadow-buttonbox font-Messina-Sans 2xl:px-36 px-10 py-10 items-center justify-center'>
			<div className='flex lg:flex-row flex-col items-center justify-between w-full h-fit self-start'>
			...
			<div className='flex sm:flex-row flex-col items-center justify-between w-full mt-4 gap-4'>
				...
				<div className='flex w-full sm:justify-end justify-center'>
					...
					<a href='#terms-of-use' className='text-sm leading-4 text-white hover:text-yellow'>
						Terms of Use
					</a>
				</div>
			</div>
