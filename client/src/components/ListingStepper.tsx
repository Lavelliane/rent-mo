...
export default function ListingStepper({ updateData }: Props) {
	...
	return (
		<form
			...
			className='flex flex-col min-h-[720px] self-center w-full bg-white px-4 py-10 sm:p-12 drop-shadow-md rounded-lg mt-5 m-2 justify-between'
		>
			<div>
				<h1
					tabIndex={0}
