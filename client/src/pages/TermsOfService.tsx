...
const TermsOfService = () => {
  return (
    <>
      <div className="flex flex-col w-full h-fit pb-16 bg-cover bg-no-repeat font-Messina-Sans">
        <Navbar />
      ...
      <div className="w-9/12 mx-auto">
        ...
        <p>
          Welcome to RentMo ("we," "us," "our"). These Terms of Service
        ...
        <p>
          ...
          must provide accurate and complete information and update it as
          needed.
        </p>
        <p>
          <strong>3. Content</strong>
          <br />
          You retain ownership of the content you submit to our services. By
        ...
        <p>
          ...
          <br />
          You agree not to engage in activities that violate these Terms or
          applicable laws, including unauthorized access, distribution of
          malware, and harassment of others.
        </p>
        <p>
        ...
        <p>
          ...
          account information and agree not to share your credentials with
          others.
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          All content and intellectual property on our website are owned by us.
          You may not reproduce, modify, or distribute our content without
          permission.
        </p>
        <p>
          ...
          do not guarantee the accuracy, completeness, or reliability of our
          content.
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          By using our services, you consent to receiving communications from us
          electronically, including emails, messages, and notifications.
        </p>
        <p>
          <strong>17. Indemnification</strong>
          <br />
          You agree to indemnify and hold us harmless from any claims,
          liabilities, and expenses arising from your use of our services or
          violation of these Terms.
        </p>
        <p>
          <strong>18. Severability</strong>
          <br />
          If any provision of these Terms is deemed invalid or unenforceable, it
          shall be removed without affecting the validity of the remaining
          provisions.
        </p>
        <p>
          These are just highlights of our Terms. Please review the full Terms
          for more details.
        </p>
      </div>
      <br />
