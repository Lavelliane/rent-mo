  ...
  return (
    <>
      ...
      <div className="w-9/12 mx-auto mb-10">
        ...
        <p>
          Have a question, suggestion, or need assistance? Feel free to reach
          out to us.
        </p>
        <div className="mt-4">
          <h2 className="text-xl font-semibold mb-2">Customer Support</h2>
          <p>
            If you need help with your account, reservations, or have any
            inquiries, our customer support team is here for you.
          </p>
          <p>
        ...
        <div className="mt-4">
          ...
          <p>
            For business-related inquiries, partnerships, and collaborations,
