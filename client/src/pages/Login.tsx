...
const Login = () => {
	...
	return (
		<>
			<div
				className='h-screen w-full bg-cover bg-center flex flex-col font-Messina-Sans justify-evenly items-center'
				style={{ backgroundImage: `url(${BgHomepage})` }}>
				<div className='flex w-full h-fit justify-center items-start'>
					<img className=' w-48 inline self-center no-select' src='../src/assets/logo/RentMo-logo.svg'></img>
				</div>
				<div className='xl:px-20 md:px-10 sm:px-6 px-4 2xl:mx-auto 2xl:container md:flex items-center justify-center'>
					<form onSubmit={handleSubmit} className='bg-white shadow-searchbox rounded sm:py-8 sm:px-10 px-4 py-6'>
						<p tabIndex={0} className=' focus:outline-none text-2xl font-extrabold text-gray-800 text-center'>
							Welcome back
						</p>
