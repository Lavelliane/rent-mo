...
const ErrorPage = () => {
	return (
		...
		>
			<div className='absolute inset-0 bg-black opacity-70 px-10'>
				<div className='flex flex-col items-center justify-center text-center w-full h-full'>
					...
					<a
						href='/landing'
						className=' lg:w-auto my-20  px-2 sm:px-10 py-3.5 border border-white text-white bg-transparent hover:bg-white hover:text-black transition-all focus:outline-none focus:ring-2 focus:ring-golden-yellow-500 focus:ring-opacity-50 md:text-base text-sm '
					>
						Go back to Homepage
					</a>
				</div>
