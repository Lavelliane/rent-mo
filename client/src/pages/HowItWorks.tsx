...
const HowItWorks = () => {
	return (
		<div className='  font-Messina-Sans'>
			<div className='flex flex-col w-full h-fit bg-cover bg-no-repeat'>
				<Navbar />
						...
						<div className='relative'>
							...
							<div className='absolute inset-0 flex flex-col justify-center items-center rounded-2xl'>
								<p className='text-white text-center  text-xl pt-20 pl-10 pr-10'>
									Want to make some extra money on the side? Be a part of the car-sharing marketplace on RentMo. List
									your vehicle and become a host today!
								</p>
								<a
									href='/login'
